...
{ constructor( camera_transform = Mat4.identity(), projection_transform = Mat4.identity(), view_transform = Mat4.identity() ) 
    { Object.assign( this, { camera_transform, projection_transform, view_transform, animation_time: 0, animation_delta_time: 0, lights: [] } ); }
}
...
{ constructor(             gl, filename, use_mipMap = true, use_cubemap = false, bool_will_copy_to_GPU = true )
    { Object.assign( this, {   filename, use_mipMap,  use_cubemap,       bool_will_copy_to_GPU,       id: gl.createTexture() } );
      if(use_cubemap)
      {
          var faces = [["assets/stars.png", gl.TEXTURE_CUBE_MAP_POSITIVE_X],
                       ["assets/stars.png", gl.TEXTURE_CUBE_MAP_NEGATIVE_X],
                       ["assets/grass.png", gl.TEXTURE_CUBE_MAP_POSITIVE_Y],
                       ["assets/stars.png", gl.TEXTURE_CUBE_MAP_NEGATIVE_Y],
                       ["assets/stars.png", gl.TEXTURE_CUBE_MAP_POSITIVE_Z],
                       ["assets/stars.png", gl.TEXTURE_CUBE_MAP_NEGATIVE_Z]];
          ...
          for (var i = 0; i < faces.length; i++) {
             ...
             var face = faces[i][1];
              ...
              gl.texImage2D (face, 0, gl.RGBA, 1, 1, 0, gl.RGBA, gl.UNSIGNED_BYTE, new Uint8Array([255, 0, 0, 255]));
