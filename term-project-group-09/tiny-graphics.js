  ...
  static insert_transformed_copy_into( recipient, args, points_transform = Mat4.identity() )    // For building compound shapes.
    { const temp_shape = new this( ...args );  // If you try to bypass making a temporary shape and instead directly insert new data into
      ...
      { if( a == "positions" )                          // Apply points_transform to all points added during this call:
        ...
        else if( a == "normals" || a == "tangents")                       // Do the same for normals, but use the inverse transpose matrix as math requires:
...
{ constructor(             gl, filename, use_mipMap = true, use_cubemap = false, bool_will_copy_to_GPU = true )
    { Object.assign( this, {   filename, use_mipMap,  use_cubemap,       bool_will_copy_to_GPU,       id: gl.createTexture() } );
      if(use_cubemap)
      {
          var faces = [["assets/scissor-reflection.png", gl.TEXTURE_CUBE_MAP_POSITIVE_X],
                       ["assets/scissor-reflection.png", gl.TEXTURE_CUBE_MAP_NEGATIVE_X],
                       ["assets/hex-reflection-dark.jpg", gl.TEXTURE_CUBE_MAP_POSITIVE_Y],
                       ["assets/hex-reflection-dark.jpg", gl.TEXTURE_CUBE_MAP_NEGATIVE_Y],
                       ["assets/scissor-reflection.png", gl.TEXTURE_CUBE_MAP_POSITIVE_Z],
                       ["assets/scissor-reflection.png", gl.TEXTURE_CUBE_MAP_NEGATIVE_Z]];
